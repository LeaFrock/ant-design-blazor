...
public abstract class DatePickerBase<TValue> : AntInputComponentBase<TValue>, IDatePicker
{
    ...
    protected string[] _placeholders = [string.Empty, string.Empty];
    ...
    internal DatePickerStatus[] _pickerStatus = [new(), new()];

    protected Stack<DatePickerType> _prePickerStack = new();
    ...
    protected ClassMapper _panelClassMapper = new();

    private static readonly int[] _hours = [.. Enumerable.Range(0, 24)];
    private static readonly int[] _minutesSeconds = [.. Enumerable.Range(0, 60)];
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        if (_needRefresh && IsRange)
        {
            ...
            else if (_inputEnd.IsOnFocused)
            {
                ...
                var translateDistance = element.ClientWidth + 16;
