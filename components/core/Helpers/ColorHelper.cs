...
{
#if NET8_0_OR_GREATER
    private static readonly FrozenDictionary<Color, string> _colors = DictColors().ToFrozenDictionary();
#else
    private static readonly Dictionary<Color, string> _colors = DictColors();
#endif

    public static string GetBackgroundStyle(Color color) => _colors[color];

    private static Dictionary<Color, string> DictColors() => new()
    {
